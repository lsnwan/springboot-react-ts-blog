...
public class ExploreController {
    ...
    @GetMapping("")
    public ResponseEntity<?> exploreBlogContent(@ModelAttribute @Valid CommonDto.Request request) {

        List<BlogContentDto> blogContents = blogService.getBlogContent(null, request.getPageIndex(), request.getPageUnit(), false, request.getCondition().toUpperCase());
