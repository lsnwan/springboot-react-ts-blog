...
const ShoppingExplore = () => {
  ...
  const loadContents = async () => {
    if (!lastRequest) {
      await axios.get(`/api/explore?pageIndex=${pageIndex}&pageUnit=10&condition=SHOPPING`)
        .then(res => res.data)
  ...
  return (
    <ContentBody>
      ...
      <TitleContainer width={windowWidth}>
        <h2 className="fw-semibold">쇼핑</h2>
      </TitleContainer>
...
export default ShoppingExplore;